        ...
        <div class="col-lg-8">
                        ...
                        <tbody>
                            @foreach($carrito as $id => $item)
                                <tr>
                                    ...
                                    <td class="text-center small" style="color: #cbd5e1;">
                                        {{ \Carbon\Carbon::parse($item['fecha_entrada'] ?? now())->format('d/m/Y') }}<br>
                                        <span style="color: #94a3b8;">a</span><br>
            ...
            @else
                <div class="card card-tramonto p-5 text-center shadow-lg">
                    <i class="bi bi-calendar-x mb-3" style="font-size: 3.5rem; color: #94a3b8;"></i>
                    <h3 class="fw-bold" style="color: #cbd5e1;">Tu carrito está vacío</h3>
                    <p style="color: #94a3b8;">Explorá nuestro catálogo para elegir las mejores habitaciones en Empedrado.</p>
                    <div class="mt-3">
            ...
            <div class="col-lg-4">
                <div class="card card-tramonto p-4 shadow-lg sticky-top" style="top: 100px;">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <span style="color: #cbd5e1;">Total Habitaciones:</span>
